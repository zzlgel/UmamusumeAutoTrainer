...
UI_FACTOR_DOUBLE_CONFIRM = Template("FACTOR_DOUBLE_CONFIRM", UMAMUSUME_UI_TEMPLATE_PATH)
...
# 青春训练，即将魂爆，已经魂爆
REF_YOUTHCAP_TRAIN = Template("YOUTHCAP_TRAIN", UMAMUSUME_REF_TEMPLATE_PATH)
REF_YOUTHCAP_TRAIN_ERUPT = Template("YOUTHCAP_TRAIN_ERUPT", UMAMUSUME_REF_TEMPLATE_PATH)
REF_YOUTHCAP_TRAIN_ERUPTED = Template("YOUTHCAP_TRAIN_ERUPTED", UMAMUSUME_REF_TEMPLATE_PATH)

REF_YOUTHCAP_RACE_RESULT = Template("YOUTHCAP_RACE_RESULT", UMAMUSUME_REF_TEMPLATE_PATH)
REF_YOUTHCAP_RACE_RESULT_NEXT = Template("YOUTHCAP_RACE_RESULT_NEXT", UMAMUSUME_REF_TEMPLATE_PATH)

UI_YOUTHCAP_GROUP_RACE = Template("YOUTHCAP_GROUP_RACE", UMAMUSUME_UI_TEMPLATE_PATH)
