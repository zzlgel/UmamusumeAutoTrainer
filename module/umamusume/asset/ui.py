...
CULTIVATE_GOAL_RACE = UI("CULTIVATE_GOAL_RACE", [template.UI_CULTIVATE_GOAL_RACE_1, template.UI_CULTIVATE_GOAL_RACE_2], [template.UI_YOUTHCAP_GROUP_RACE])
...
# 青春杯
YOUTHCAP_GROUP_RACE = UI("YOUTHCAP_GROUP_RACE", [template.UI_YOUTHCAP_GROUP_RACE], [])

# executor.run_work_flow 作为脚本系统的核心基础组件，需要维持它简洁低耦合，所以不能引入其他模块，这里的ui也就不容易做出分组
scan_ui_list = [PRESS_START, MAIN_MENU, MAIN_MENU_CONTINUE,
                ...
                FACTOR_RECEIVE, FACTOR_DOUBLE_CONFIRM, HISTORICAL_RATING_UPDATE, SCENARIO_RATING_UPDATE,
                ...
                GUILD_MAIN, GUILD_MAIN_2, DAILY_RACE_HOME, DAILY_RACE_SELECT_RACER, INFO,
                YOUTHCAP_GROUP_RACE, FUJIKISEKI_SHOW_MODE_RESULT_1, FUJIKISEKI_SHOW_MODE_RESULT_2
                ]
